...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/modepend/modepend.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/soapp/soapp.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/AsyncDisplayKit/AsyncDisplayKit.framework"
fi
